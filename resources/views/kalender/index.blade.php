...
@section('content')
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <small class="text-muted">Kelola calendar</small>
            </div>
        </div>
    ...
    <div class="card app-calendar-wrapper">
        <div class="row g-5">
            <!-- Calendar Sidebar -->
            <div class="col app-calendar-sidebar border-end w-50" id="app-calendar-sidebar">
            ...
            <!-- Calendar & Modal -->
            <div class="col-6 col-lg-9 app-calendar-content">
                    ...
                    <div class="offcanvas-body">
                        <div class="mb-4">
                            <label class="form-label fw-semibold d-flex align-items-center gap-2">
                                <i class="bx bx-calendar"></i> Pilih Tanggal
                            </label>
