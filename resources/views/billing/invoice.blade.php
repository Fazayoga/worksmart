        ...
        <div class="invoice-box">
            ...
            <div class="invoice-header d-flex justify-content-between">
                <div>
                    ...
                    <div class="mt-2">
                        <span
                            class="badge {{ $billing->payment_status == 'paid' ? 'bg-success' : 'bg-warning text-dark' }}">
            ...
            <div class="row mb-4">
                ...
                <div class="col-sm-6 text-sm-end mt-4 mt-sm-0">
                    ...
                    @if ($billing->payment_status == 'paid' && $billing->tanggal_bayar)
                        <div class="mt-2"><strong>Tgl Lunas:</strong>
                            <br>{{ $billing->tanggal_bayar->format('d/m/Y H:i') }}
                        </div>
                    @endif
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-end align-middle">
                                Rp {{ number_format($billing->nominal_total, 0, ',', '.') }},-
                            </td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <th class="text-end fs-5 text-primary">Rp
                                {{ number_format($billing->nominal_total, 0, ',', '.') }},-</th>
                        </tr>
                    </tfoot>
                </table>
            </div>
            ...
            @if ($billing->payment_status == 'unpaid' && $billing->status != 'expired')
                <div class="alert alert-info mt-4">
                    ...
                    <p class="mb-1">Silakan transfer sesuai nominal <strong>Rp
                            {{ number_format($billing->nominal_total, 0, ',', '.') }},-</strong> ke salah satu rekening
                        berikut:</p>
                    <ul class="mb-1">
                    ...
                    <p class="mb-0 text-sm">Gunakan Nomor Transaksi (<strong>{{ $billing->nomor_transaksi }}</strong>)
